...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">final prep in the garage</div>
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">packing up for race day</div>
</div>
...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">driver briefing session</div>
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">start of the race</div>
</div>
...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">
    another shot of us leading the pack
  </div>
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">
    night racing with beautiful light trails
  </div>
</div>
...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">fish prep work</div>
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">touch-up paint work</div>
</div>
...
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">grinding work on the cage</div>
  <div style="flex: 1; display: flex; text-align: center; justify-content: center; font-style: italic;">half finished</div>
</div>
